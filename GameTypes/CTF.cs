            ...
            lock (C3Mod.C3Players) 
            {
                ...
                if (CTFGameRunning)
                {
                        ...
                        foreach (C3Player player in C3Mod.C3Players)
                        {
                            ...
                            if (player.GameType == "ctf")
                            {
                                ...
                                if (!Main.player[player.Index].hostile)
                                {
                                    ...
                                    NetMessage.SendData((int) PacketTypes.TogglePvp, -1, -1, new NetworkText("", NetworkText.Mode.Formattable), player.Index, 0f, 0f,
                                                        0f);
                                }
                                ...
                                else
                                {
                                    if (player.Dead)
                                    {
                                        ...
                                        NetMessage.SendData(4, -1, player.Index, new NetworkText(player.PlayerName, NetworkText.Mode.Formattable), player.Index, 0f, 0f,
                                                            0f, 0);
                                        if (C3Mod.C3Config.TPLockEnabled)
                                        {
                                            player.TSPlayer.TpLock = true;
                    ...
                    if (Team2FlagCarrier != null)
                    {
                        ...
                        {
                            C3Tools.BroadcastMessageToGametype("ctf", Team2FlagCarrier.PlayerName + ": Dropped the flag!", Color.SkyBlue);
                            ...
                            if ((int)Team2FlagCarrier.tileX >= flagPoints[1].X - 2 && (int)Team2FlagCarrier.tileX <= flagPoints[1].X + 2 && (int)Team2FlagCarrier.tileY == (int)(flagPoints[1].Y - 3))
                            {
                                ...
                                switch (C3Mod.C3Config.TeamColor2)
                                {
                                    ...
                                    case 3:
                                        {
                                            if (C3Mod.C3Config.TeamColor1 == 1)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Red", Color.SkyBlue);
                                            else if (C3Mod.C3Config.TeamColor1 == 2)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Green", Color.SkyBlue);
                                            else if (C3Mod.C3Config.TeamColor1 == 4)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team2FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Yellow", Color.SkyBlue);
                                            break;
                                        }
                                    case 4:
                                        {
                            ...
                            if ((int)Team1FlagCarrier.tileX >= flagPoints[0].X - 2 && (int)Team1FlagCarrier.tileX <= flagPoints[0].X + 2 && (int)Team1FlagCarrier.tileY == (int)(flagPoints[0].Y - 3))
                            {
                                ...
                                switch (C3Mod.C3Config.TeamColor1)
                                {
                                    ...
                                    case 3:
                                        {
                                            if (C3Mod.C3Config.TeamColor2 == 1)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team1FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Red", Color.SkyBlue);
                                            else if (C3Mod.C3Config.TeamColor2 == 2)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team1FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Green", Color.SkyBlue);
                                            else if (C3Mod.C3Config.TeamColor2 == 4)
                                                C3Tools.BroadcastMessageToGametype("ctf", Team1FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Yellow", Color.SkyBlue);
                                            break;
                                        }
                                    case 4:
                                        {
                ...
                if (Team2Score == C3Mod.C3Config.CTFScoreLimit)
                {
                    ...
                    if (C3Mod.C3Config.TeamColor2 == 1)
                        ...
                        C3Tools.BroadcastMessageToGametype("ctf", "BLUE TEAM WINS!", Color.SkyBlue);
                    else if (C3Mod.C3Config.TeamColor2 == 4)
        ...
        public static void TpToSpawns(bool pvpstate)
        {
            for (int i = 0; i < C3Mod.C3Players.Count; i++)
            {
                if (C3Mod.C3Players[i].Team == 1)
                {
                    ...
                    NetMessage.SendData(30, -1, -1, new NetworkText("", NetworkText.Mode.Formattable), C3Mod.C3Players[i].Index, 0f, 0f, 0f);
