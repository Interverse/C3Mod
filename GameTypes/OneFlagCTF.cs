                        ...
                        if (Main.player[FlagCarrier.Index].dead)
                        {
                            if (FlagCarrier.Team == 5)
                                switch (C3Mod.C3Config.TeamColor1)
                                {
                                    ...
                                    case 3:
                                        {
                                            C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + " dropped the flag!", Color.SkyBlue);
                                            break;
                                        }
                                    case 4:
                                        {
                                ...
                                if ((int)FlagCarrier.tileX <= (int)SpawnPoint[0].X + 2 && (int)FlagCarrier.tileX >= (int)SpawnPoint[0].X - 2 && (int)FlagCarrier.tileY == (int)SpawnPoint[0].Y - 3)
                                {
                                    ...
                                    switch (C3Mod.C3Config.TeamColor1)
                                    {
                                        ...
                                        case 3:
                                            {
                                                if (C3Mod.C3Config.TeamColor2 == 1)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Red", Color.SkyBlue);
                                                else if (C3Mod.C3Config.TeamColor2 == 2)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Green", Color.SkyBlue);
                                                else if (C3Mod.C3Config.TeamColor2 == 4)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team1Score.ToString() + " --- " + Team2Score.ToString() + " - Yellow", Color.SkyBlue);
                                                break;
                                            }
                                        case 4:
                                            {
                                ...
                                if ((int)FlagCarrier.tileX <= (int)SpawnPoint[1].X + 2 && (int)FlagCarrier.tileX >= (int)SpawnPoint[1].X - 2 && (int)FlagCarrier.tileY == (int)SpawnPoint[1].Y - 3)
                                {
                                    ...
                                    switch (C3Mod.C3Config.TeamColor2)
                                    {
                                        ...
                                        case 3:
                                            {
                                                if (C3Mod.C3Config.TeamColor1 == 1)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Red", Color.SkyBlue);
                                                else if (C3Mod.C3Config.TeamColor1 == 2)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Green", Color.SkyBlue);
                                                else if (C3Mod.C3Config.TeamColor1 == 4)
                                                    C3Tools.BroadcastMessageToGametype("oneflag", FlagCarrier.PlayerName + ": Scores!  Blue - " + Team2Score.ToString() + " --- " + Team1Score.ToString() + " - Yellow", Color.SkyBlue);
                                                break;
                                            }
                                        case 4:
                                            {
