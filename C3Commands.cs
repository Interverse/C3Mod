    ...
    internal class C3Commands
    {
        ...
        public static void SetCTFTeam1Flag(CommandArgs args)
        {
            ...
            if (C3Mod.C3Config.TeamColor1 == 1)
                ...
                args.Player.SendMessage("Temporary CTF Blue flag set at your position", Color.SkyBlue);
        ...
        public static void SetCTFTeam1Spawn(CommandArgs args)
        {
            ...
            if (C3Mod.C3Config.TeamColor1 == 1)
                ...
                args.Player.SendMessage("Temporary CTF Blue spawn set at your position", Color.SkyBlue);
            else if (C3Mod.C3Config.TeamColor1 == 4)
        ...
        public static void SetOneFlagTeam1Spawn(CommandArgs args)
        {
            ...
            if (C3Mod.C3Config.TeamColor1 == 1)
                ...
                args.Player.SendMessage("Temporary One Flag CTF Blue spawn set at your position", Color.SkyBlue);
            else if (C3Mod.C3Config.TeamColor1 == 4)
        ...
        public static void SetDuelTeam1Spawn(CommandArgs args)
        {
            ...
            if (C3Mod.C3Config.TeamColor1 == 1)
                ...
                args.Player.SendMessage("Temporary Duel Blue spawn set at your position", Color.SkyBlue);
            else if (C3Mod.C3Config.TeamColor1 == 4)
        ...
        public static void SetTDMTeam1Spawn(CommandArgs args)
        {
            ...
            if (C3Mod.C3Config.TeamColor1 == 1)
                ...
                args.Player.SendMessage("Temporary TDM Blue spawn set at your position", Color.SkyBlue);
            else if (C3Mod.C3Config.TeamColor1 == 4)
        ...
        public static void SetApocMonsterSpawn(CommandArgs args)
        {
            ...
            if (Int32.TryParse(args.Parameters[0], out radius)) Apocalypse.Radius = radius;
            else Apocalypse.Radius = 10;
                    ...
                    case "ctf":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("ctf", "CTF stopped by admin", Color.SkyBlue);
                    ...
                    case "duel":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("1v1", "Duel stopped by admin", Color.SkyBlue);
                    ...
                    case "oneflag":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("oneflag", "One flag stopped by admin", Color.SkyBlue);
                    ...
                    case "apocalypse":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("apoc", "Apocalypse stopped by admin", Color.SkyBlue);
                    ...
                    case "tdm":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("tdm", "Team Deathmatch stopped by admin", Color.SkyBlue);
                    ...
                    case "ffa":
                        {
                            ...
                            {
                                C3Tools.BroadcastMessageToGametype("ffa", "Free For All stopped by admin", Color.SkyBlue);
                            ...
                            if (C3Mod.C3Config.CTFEnabled)
                            {
                                if (CTF.Arenas.Count > 0 && CTF.Arenas.Count >= arena)
                                {
                                    if (!CTF.CTFGameRunning && !CTF.CTFGameCountdown)
                                    {
                                        ...
                                        TShock.Utils.Broadcast("Vote to play Capture the Flag started by: " + args.Player.Name + ".", 0, 255, 255);
                                        TShock.Utils.Broadcast("Type /join to join the lobby for this game! Arena: " + CTF.Arenas[arena - 1].Name, 0, 255, 255);
                                        if (!args.Player.HasPermission("c3mod.hostonly")) {
                                            C3Tools.AssignTeam(C3Tools.GetC3PlayerByIndex(args.Player.Index), "ctf");
                                        }
                                        CTF.Team2Score = 0;
                                        CTF.Team1Score = 0;
                            ...
                            if (C3Mod.C3Config.OneFlagEnabled)
                            {
                                if (OneFlagCTF.Arenas.Count > 0 && OneFlagCTF.Arenas.Count >= arena)
                                {
                                    if (!OneFlagCTF.OneFlagGameRunning && !OneFlagCTF.OneFlagGameCountdown)
                                    {
                                        ...
                                        if (!args.Player.HasPermission("c3mod.hostonly")) {
                                            C3Tools.AssignTeam(C3Tools.GetC3PlayerByIndex(args.Player.Index), "oneflag");
                                        }
                            ...
                            if (C3Mod.C3Config.TeamDeathmatchEnabled)
                            {
                                if (TDM.Arenas.Count > 0 && TDM.Arenas.Count >= arena)
                                {
                                    if (!TDM.TDMRunning && !TDM.TDMCountdown)
                                    {
                                        ...
                                        if (!args.Player.HasPermission("c3mod.hostonly")) {
                                            C3Tools.AssignTeam(C3Tools.GetC3PlayerByIndex(args.Player.Index), "tdm");
                                        }
                                        TDM.Team2Score = 0;
                                        TDM.Team1Score = 0;
                                        C3Mod.VoteType = "tdm";
                        ...
                        case "ctf":
                            {
                                ...
                                switch (team)
                                {
                                    ...
                                    case "Blue":
                                        {
                                            args.Player.SendMessage("You have been auto assigned to the Blue team!", Color.SkyBlue);
                                            break;
                                        }
                                    case "Yellow":
                                        {
        ...
        public static void Quit(CommandArgs args)
        {
            ...
            if (player.GameType != "")
            {
                ...
                NetMessage.SendData((int)PacketTypes.TogglePvp, -1, -1, new NetworkText("", NetworkText.Mode.Formattable), player.TSPlayer.Index);
                player.LivesUsed = 0;
            }
            else
